...
namespace P03_SalesDatabase.Data
{
    public class SalesContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder
                    .UseSqlServer(@"Server=LENOVO-PC\SQLEXPRESS;Database=Sales;Integrated Security=true");
            }
        ...
        {
            modelBuilder.Entity<Customer>().Property(x => x.Email).HasColumnType("varchar(80)");
